...
public class AttendanceController {
    ...
    @Autowired
    private UserService userService;  // Assuming you have a UserService bean in your application context

    @Autowired
    public AttendanceController(IAttendanceService attendanceService, AttendanceMapper attendanceMapper) {
