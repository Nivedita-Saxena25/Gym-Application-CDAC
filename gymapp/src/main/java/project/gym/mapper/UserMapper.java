...
public class UserMapper {
	 ...
	 public static Users dtoToCustomerEntity(RegistrationRequestDto registrationRequestDto) {
	        if (registrationRequestDto == null || registrationRequestDto.getUserdto() == null) {
	            throw new InvalidRegistrationException("Invalid registration request: RegistrationRequestDto or Userdto is null");
	        }
	        ...
	        if (StringUtils.isEmpty(userDTO.getFirstName()) || StringUtils.isEmpty(userDTO.getLastName())
	                || StringUtils.isEmpty(registrationRequestDto.getUsername()) || StringUtils.isEmpty(registrationRequestDto.getPassword())) {
...
>>>>>>> branch 'Nivedita' of https://github.com/Nivedita-Saxena25/Health-Fitness-Management-System.git
        ...
        if (userEntity.getRegistrationDate() != null) {
            userResponseDTO.setRegistrationDate(
                Instant.ofEpochMilli(userEntity.getRegistrationDate().getTime())
