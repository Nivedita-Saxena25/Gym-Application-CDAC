...
public class DietPlanController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<DietPlanDto> updateDietPlan(@PathVariable Long id, @RequestBody DietPlanDto updatedDietPlanDto) {
        try {
            ...
            if (existingDietPlan != null) {
                ...
                DietPlan updatedDietPlan = DietPlanMapper.dtoToEntity(updatedDietPlanDto, userService.getUserById(userId));
